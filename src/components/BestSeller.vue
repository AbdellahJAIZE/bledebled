      ...
      <div class="best-sell-slider owl-carousel owl-nav-style">
        ...
        <article class="list-product">
          ...
          <div class="product-decs">
            ...
            <h2>
              <a href="single-product.html" class="product-link"
                >Brixton Patrol All Terrain Ano..</a
              >
            </h2>
            <div class="rating-product">
              <i class="ion-android-star"></i>
        ...
        <article class="list-product">
          ...
          <div class="product-decs">
            ...
            <h2>
              <a href="single-product.html" class="product-link"
                >Juicy Couture Tricot Logo Strip..</a
              >
            </h2>
            <div class="rating-product">
              <i class="ion-android-star"></i>
        ...
        <article class="list-product">
          ...
          <div class="product-decs">
            ...
            <h2>
              <a href="single-product.html" class="product-link"
                >Water and Wind Resistant Ins..</a
              >
            </h2>
            <div class="rating-product">
              <i class="ion-android-star"></i>
        ...
        <article class="list-product">
          ...
          <div class="product-decs">
            ...
            <h2>
              <a href="single-product.html" class="product-link"
                >New Luxury Men's Slim Fit Shi...</a
              >
            </h2>
            <div class="rating-product">
              <i class="ion-android-star"></i>
        ...
        <article class="list-product">
          ...
          <div class="product-decs">
            ...
            <h2>
              <a href="single-product.html" class="product-link"
                >Brixton Patrol All Terrain Anor...</a
              >
            </h2>
            <div class="rating-product">
              <i class="ion-android-star"></i>
